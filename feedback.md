...
- Student Being Reviewed: Alex Robertson
- Reviewer: Lizeth Vera
- Classroom: Time
...
<table>
  ...
  <tr>
    ...
    <td>
      no / However there is a config for that in test_helper.
    </td>
  </tr>
...
<table>
  ...
  <tr>
   ...
   <td>
      ✅ The comments when the input is not valid are very good. I see some improvement when the input is list of channels or users, since it ends the execution. Maybe should show the other menu options.
   </td>
  </tr>`
</table>
