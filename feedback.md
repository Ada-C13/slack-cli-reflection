...
<table>
  ...
  <li>Complex logic is broken into smaller helper methods. (There aren’t more than one or two methods that are 30 lines or more)
   ...
   <td>
      no (main method in the slack.rb has more than 30 lines)
   </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      yes (It will be great to provide more details for the "add tests" commits.)
    </td>
  </tr>
</table>
...
<table>
  ...
  <tr>
   ...
   <td>
      no ("Method Missing" message shows up in the ID column when trying to select a user)
   </td>
  </tr>
