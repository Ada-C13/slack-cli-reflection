...
- Student Being Reviewed: Nataliya Pogodina
- Reviewer: Yesenia Torres
- Classroom: Time
...
<table>
  ...
  <tr>
   ...
   <td>
      yes, this is done neatly in Recipient class
   </td>
  </tr>
  ...
  <tr>
   ...
   <td>
      yes, makes use of both  types of methods
   </td>
  </tr>
  ...
  <li>Complex logic is broken into smaller helper methods. (There aren’t more than one or two methods that are 30 lines or more)
   ...
   <td>
      yes, thoughtful use of a "menu" helper function to display options to CLI user
   </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      yes, very thorough test of all classes, especially Recipient class
    </td>
  </tr>
...
<table>
  ...
  <tr>
   ...
   <td>
      yes, good idea to incorporate the user's time zone when displaying details
   </td>
  </tr>
  ...
  <tr>
   ...
   <td>
      yes, could be useful to relay the CLI user's input back to them when displaying error message
   </td>
  </tr>
</table>
