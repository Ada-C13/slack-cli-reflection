...
<table>
  ...
  <tr>
    <td>
      1. Implements inheritance and inheritance idioms. There is a Recipient class. User and Channel inherit from Recipient. In Recipient, there are appropriate methods defined that are used in both User and Channel. Some may be implemented. Some may be template methods.	
   </td>
   <td>
      yes
   </td>
  ...
  <li>lib/slack.rb only interacts with Workspace (to show a separation of responsibilities). </li>
  ...
  <tr>
   <td>
    1. Practices instance methods vs. class methods appropriately. (The methods to list all Channels or Users is a class method within those respective classes.)
   </td>
   <td>
      yes
   </td>
  ...
  <tr>
    <td>
      1. Practices git with at least 15 small commits and meaningful commit messages	
   </td>
    <td>
      yes
    </td>
